...
Rect::Rect(const Point& topLeft, const Point& botRight)
	:_topLeft(topLeft), _bottomRight(botRight)
{
	//_topLeft = topLeft;
	//_bottomRight = botRight;
}
	...
	:_topLeft(left, top), _bottomRight(right, bottom)
{
	...
	//_bottomRight = Point(right, bottom);
}

Rect::~Rect()
{
	cout << "Rect ¼Ò¸êÀÚ È£Ãâ!" << endl;
}
